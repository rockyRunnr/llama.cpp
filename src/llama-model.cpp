            ...
            case LLM_ARCH_GLM4:
                {
                    ...
                    for (int i = 0; i < n_layer; ++i) {
                        ...
                        layer.wqkv      = create_tensor(tn(LLM_TENSOR_ATTN_QKV, "weight", i),
                                                        { n_embd, n_embd + 2 * n_embd_gqa }, flags | TENSOR_NOT_REQUIRED);
                        layer.bqkv      = create_tensor(tn(LLM_TENSOR_ATTN_QKV, "bias", i), { n_embd + 2 * n_embd_gqa },
                        ...
                        if (layer.wqkv == nullptr) {
                            ...
                            layer.wk =
                                create_tensor(tn(LLM_TENSOR_ATTN_K, "weight", i), { n_embd, n_embd_k_gqa }, flags);
                            layer.wv =
                                create_tensor(tn(LLM_TENSOR_ATTN_V, "weight", i), { n_embd, n_embd_v_gqa }, flags);
                        ...
                        layer.ffn_post_norm =
                            create_tensor(tn(LLM_TENSOR_FFN_POST_NORM, "weight", i), { n_embd }, flags);
            ...
            case LLM_ARCH_LFM2MOE:
                {
                    ...
                    dense_2_out_layers_b = create_tensor(tn(LLM_TENSOR_DENSE_2_OUT, "bias"), { hparams.n_embd_out() },
                                                         TENSOR_NOT_REQUIRED);
                }
                break;
            case LLM_ARCH_SMALLTHINKER:
        ...
        default:
            {
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_kv_cache_paged(*this, params.type_k, params.type_v, !cparams.flash_attn,
                                                       cparams.offload_kqv, cparams.kv_unified, cparams.n_ctx_seq,
                                                       cparams.n_seq_max, 1, hparams.n_swa, hparams.swa_type, nullptr,
                                                       nullptr, 256);
                    } else {
                        GGML_ASSERT(!hparams.is_swa_any());
